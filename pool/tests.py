...
class ImageTestClass(TestCase):
    ...
    def setUp(self):
        ...
        self.new_image = Image(pic='bg.jpg',title='Ozura',description='The landscape of heaven',category=self.new_category,location=self.new_location)
        self.new_image.save()
    ...
    def test_update_image(self):
        ...
        self.updated_image = Image.objects.filter(pic=self.id).update(pic='bg2.jpg',title='Alimbi',description='The truths of yesterday',category=self.updated_category,location=self.updated_location)
